...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{outputs/q4/figs/fig_q4_env_components.png}
\caption{环境成分堆叠图}
\end{figure}
\begin{center}
\begin{longtable}{|l|l|l|l|l|}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{outputs/q4/figs/fig_q4_soot_timeseries.png}
\caption{黑碳时间序列}
\end{figure}
\begin{center}
\begin{longtable}{|l|l|l|l|l|}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{outputs/q4/figs/fig_q4_pareto_edi_cost.png}
\caption{EDI-成本帕累托}
\end{figure}
\begin{center}
\begin{longtable}{|l|l|l|l|l|}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{outputs/q4/figs/fig_q4_chi_sensitivity.png}
\caption{脱碳敏感性}
\end{figure}
\begin{center}
\begin{longtable}{|l|l|l|l|l|}
